...
if __name__ == '__main__':
    ...
    model = Sequential([
        Conv3D(32, (3, 3, 3), activation='relu', input_shape=(30, 96, 176, 1)),
        MaxPooling3D((2, 2, 2)),
    ...
    model.fit(training_data, training_labels_categorical, epochs=50, batch_size=16, validation_split=0.2)
